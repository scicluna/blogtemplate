...
export default function NewPostForm() {
    ...
    return (
        <form className="shadow-md shadow-red-200 h-4/6 relative font-extrabold text-lg flex flex-col gap-5 px-2 py-4 bg-red-300">
            <div className="flex justify-between">
                ...
                <button type="submit" onSubmit={submitBlogPost} className=" text-black hover:text-red-600 transition-all duration-300 p-2 rounded-full">Submit</button>
            </div>
